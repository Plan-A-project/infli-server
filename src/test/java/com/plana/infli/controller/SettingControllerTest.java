...
//            login();
//            MyProfileResponse responseDto = new MyProfileResponse("youngjin", Role.STUDENT,
//                "youngjin@gmail.com");
//
...
//            login();
//            ModifyNicknameRequest requestDto = new ModifyNicknameRequest("youngjin@gmail.com", "change");
//
...
//            login();
//            ModifyNicknameRequest requestDto = new ModifyNicknameRequest("youngjin@gmail.com", "changeNickname");
//
//            String content = objectMapper.writeValueAsString(requestDto);
//
//            ResultActions perform = mockMvc.perform(post("/member/profile/nickname/modify")
...
//            login();
//            AuthenticatePasswordRequest requestDto = new AuthenticatePasswordRequest("youngjin@gmail.com", "Test1234!");
//
//            String content = objectMapper.writeValueAsString(requestDto);
//
...
//            login();
//            AuthenticatePasswordRequest requestDto = new AuthenticatePasswordRequest("youngjin@gmail.com", "notMatch123!");
//
//            String content = objectMapper.writeValueAsString(requestDto);
//
//            ResultActions perform = mockMvc.perform(post("/member/profile/password/confirm")
...
//            login();
//            ModifyPasswordRequest requestDto = new ModifyPasswordRequest("youngjin@gmail.com", "newPassword1234!");
//
//            String content = objectMapper.writeValueAsString(requestDto);
//
...
//            login();
//
//            UnregisterMemberRequest requestDto = new UnregisterMemberRequest("youngjin@gmail.com", "testNickname");
//
//            String content = objectMapper.writeValueAsString(requestDto);
//
...
//            signup();
//            MyProfileResponse responseDto = new MyProfileResponse("testNickname", Role.STUDENT,
//                "youngjin@gmail.com");
//
//            ResultActions perform = mockMvc.perform(get("/member/profile")
//                .contentType(MediaType.APPLICATION_JSON));
